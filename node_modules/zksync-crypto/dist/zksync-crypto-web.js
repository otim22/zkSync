...
export async function loadZkSyncCrypto(wasmFileUrl) {
  if (!wasmSupported()) {
    ...
    return require('./zksync-crypto-bundler_asm.js');
  }
  if (!wasmFileUrl) {
