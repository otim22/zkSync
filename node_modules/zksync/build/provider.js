...
function getDefaultProvider(network, transport = 'HTTP', pollIntervalMilliSecs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (network === 'localhost') {
            ...
            if (transport === 'WS') {
                return yield Provider.newWebsocketProvider('wss://ropsten-api.zksync.io/jsrpc-ws', network);
            }
            else if (transport === 'HTTP') {
                return yield Provider.newHttpProvider('https://ropsten-api.zksync.io/jsrpc', pollIntervalMilliSecs, network);
            }
        }
        else if (network === 'rinkeby') {
            if (transport === 'WS') {
                return yield Provider.newWebsocketProvider('wss://rinkeby-api.zksync.io/jsrpc-ws', network);
            }
            else if (transport === 'HTTP') {
                return yield Provider.newHttpProvider('https://rinkeby-api.zksync.io/jsrpc', pollIntervalMilliSecs, network);
            }
        }
        else if (network === 'ropsten-beta') {
            if (transport === 'WS') {
                return yield Provider.newWebsocketProvider('wss://ropsten-beta-api.zksync.io/jsrpc-ws', network);
            }
            else if (transport === 'HTTP') {
                return yield Provider.newHttpProvider('https://ropsten-beta-api.zksync.io/jsrpc', pollIntervalMilliSecs, network);
            }
        }
